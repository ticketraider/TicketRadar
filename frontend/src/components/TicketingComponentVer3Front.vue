...
<!--  // 예제: 허용된 날짜를 '2024-03-20'부터 '2024-03-25'로 설정-->
<!--  // 실제 구현에서는 이벤트의 시작일과 종료일을 기반으로 변경해야 함-->
...
<!--      // 각 등급별 가격과 개수 설정-->
<!--      const grades = {-->
<!--        R: { price: 100000, count: 30 },-->
<!--        S: { price: 80000, count: 60 },-->
<!--        A: { price: 60000, count: 45 },-->
<!--      };-->
<!--      const seats = [];-->
<!--      let id = 1;-->

<!--      // 예약된 좌석의 ID 목록-->
<!--      const bookedSeatsIds = [`R1`, `S2`, `A3`]-->
